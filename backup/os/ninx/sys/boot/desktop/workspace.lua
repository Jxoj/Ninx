...
local tArg = {...}
local instances = {}
local configPath = "ninx/.sys/config/workspace.cfig"
local useConfig = false		
local config = {
	workspaceMoveSpeed = 0.15,
	defaultProgram = "ninx/.sys/shell.lua",
	timesRan = 0,
...
lddterm.useColors = true			
lddterm.baseTerm = term.current()	
lddterm.transformation = nil		
lddterm.cursorTransformation = nil	
lddterm.drawFunction = nil			
lddterm.adjustX = 0					
lddterm.adjustY = 0					
lddterm.selectedWindow = 1			
lddterm.windows = {}				
lddterm.nativePalettes = {			
	[ 1 ] = {
		0.94117647409439,
		0.94117647409439,
		0.94117647409439,
...
local newInstance = function(x, y, program, initialStart)
	...
	local func = function()
		...
		local drawInactiveScreen = function()
			...
			cwrite("This Ninxspace is inactive.", 0 + scr_y / 2)
